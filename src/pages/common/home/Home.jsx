...
function Home() {
  ...
  const [maxPriceMin, setMaxPriceMin] = useState(6000000);
  const [minPriceMax, setMinPriceMax] = useState(500000);
  const [maxPriceMax, setMaxPriceMax] = useState(6000000);
