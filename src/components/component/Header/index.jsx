...
const Header = () => {
  ...
  return (
    <div className="header">
      {!isScrolled ? (
        <div className={`topHeader ${isScrolled ? "scrolled" : "disScrolled"}`}>
          <u>
            Được khách yêu thích – những chỗ ở được ưa thích nhất trên HolaRent
          </u>
        </div>
      ) : (
        <></>
          ...
          <div className="borderAction">
            ...
            <div className="userAvatar">
              {account?.phone !== undefined ? (
                <img className="avatarHeader" src={avatarHeader} />
              ) : (
                <AccountCircleIcon />
              )}
            </div>
            ...
            <div className="inforNav">
              ...
              <div className="loginNav">
                <ul>
                  ...
                  {account?.phone !== undefined && account.role === "admin" ? (
                    <li onClick={() => navigate("/admin/blogManager")}>
                      <span>Dashboard</span>
                    </li>
                  ) : (
                    <></>
